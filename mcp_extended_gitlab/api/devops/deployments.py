...
def register(mcp: FastMCP):
    ...
    async def create_deployment(
        ...
        status: Optional[str] = Field(default="created", description="The status to filter deployments by")
    ) -> Dict[str, Any]:
        """Create a deployment."""
        client = await get_gitlab_client()
        data = {
    ...
    async def approve_blocked_deployment(
        ...
        represented_as: Optional[str] = Field(default=None, description="The name of the User/Group/Role to use for the approval")
    ) -> Dict[str, Any]:
    ...
    async def list_merge_requests_for_deployment(
        project_id: str = Field(description="The ID or URL-encoded path of the project"),
        deployment_id: str = Field(description="The ID of the deployment"),
        environment: Optional[str] = Field(default=None, description="The name of the environment")
    ) -> Dict[str, Any]:
